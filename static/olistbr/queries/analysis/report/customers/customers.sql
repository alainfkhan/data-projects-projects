...
SELECT
    ...
    -- utils.fn_format_brl(sum(o.price)) as unrealised_product_revenue,
    -- utils.fn_format_brl(sum(o.freight_value)) as unrealised_freight_revenue,
    utils.fn_format_brl(SUM(o.price + o.freight_value))
        AS unrealised_total_revenue
